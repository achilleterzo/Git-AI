...
contextBridge.exposeInMainWorld('directoryAPI', {
  ...
  hasOllamaCloudApiKey: () => ipcRenderer.invoke('has-ollama-cloud-api-key'),
  saveOllamaCloudApiKey: (value) => ipcRenderer.invoke('save-ollama-cloud-api-key', String(value || '')),
  ...
  fetchModels: (provider, endpoint, apiKey = '') => ipcRenderer.invoke('fetch-models', { provider, endpoint, apiKey: String(apiKey || '') }),
