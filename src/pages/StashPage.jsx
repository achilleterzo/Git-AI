...
export default function StashPage({ directory, projects, choose, selectProject, removeProjectOption, active, stop, resume, defaultPathIcon, currentBranch, gitLfs, onBranchSwitch, incomingCommits, outgoingCommits, hasUpstream, selected, aiBusy, gitBusy, generateCommitMessage, generateStashMergeMessage, mergeStashes, runGitRemote, requestPush, requestDeleteStash, selectedStashes, restoreStash, changes, query, setQuery, expanded, toggleFolder, toggleSelection, expandAllFolders, collapseAllFolders, openDiff, stashes, setSelectedStashes, expandedStashRef, setExpandedStashRef }) {
  ...
  return (
    <div className="tab-page stash-page">
      ...
      <RepositoryActionsBar {...{ directory, currentBranch, gitLfs, onBranchSwitch, incomingCommits, outgoingCommits, hasUpstream, selected, aiBusy, gitBusy, generateCommitMessage, generateStashMergeMessage, mergeStashes, runGitRemote, requestPush, requestDeleteStash, selectedStashes, selectedStashFiles: [...stashFileSelected], restoreStash: restoreSelectedStash }} showStashOutside showRestore showDeleteStash showRevert={false} />
