...
export default function RepositoryActionsBar({ directory, currentBranch, gitLfs, onBranchSwitch, incomingCommits, outgoingCommits, hasCommits, selected, aiBusy, gitBusy, generateCommitMessage, generateStashMergeMessage, runGitRemote, requestPush, requestRevert, requestDeleteStash, selectedStashes = [], selectedStashFiles = [], restoreStash, mergeStashes, onTagCommit, showCommit = false, showAmend = false, showPull = false, showPush = false, showStash = false, showStashOutside = false, showRestore = false, showRevert = false, showDeleteStash = false, showTag = false }) {
